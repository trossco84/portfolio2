#!/usr/bin/env python3
"""
Database-free monthly portfolio deep-dive.

Connects directly to Alpaca and fetches news for comprehensive analysis.
"""
...
def main():
    """Run monthly deep-dive without database."""
    print("="*80)
    print("MONTHLY PORTFOLIO DEEP-DIVE (Standalone)")
    print("="*80)
    ...
    try:
        ...
        email_body = f"""
📊 MONTHLY PORTFOLIO DEEP-DIVE - {date.today()}
...
"""
        ...
        email_file = Path(__file__).parent.parent / f"reports/monthly_deep_dive_{today_str}.txt"
        ...
        # Send email
        subject = f"📊 Monthly Portfolio Deep-Dive - {date.today()}"
